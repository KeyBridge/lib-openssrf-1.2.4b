...
public class RxStd extends Std<RxStd> {
  ...
  protected List<RxStd.RxSpec> rxSpec;

  public List<RxStd.RxSpec> getRxSpec() {
    if (rxSpec == null) {
      rxSpec = new ArrayList<>();
    }
    return this.rxSpec;
  }
  ...
  public static class RxSpec {
    ...
    protected List<RxStd.RxSpec.RxSpurious> rxSpurious;
    /**
    ...
    public List<RxStd.RxSpec.RxSpurious> getRxSpurious() {
      if (rxSpurious == null) {
        rxSpurious = new ArrayList<>();
      }
