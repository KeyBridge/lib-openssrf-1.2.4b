...
public class SSReply extends Common<SSReply> {
  ...
  protected List<HostNationConstraints> hostNationConstraints;
   ...
   * @since 3.1.0
   */
  public List<HostNationConstraints> getHostNationConstraints() {
    if (hostNationConstraints == null) {
      hostNationConstraints = new ArrayList<>();
    }
