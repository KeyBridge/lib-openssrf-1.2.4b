...
@XmlType(name = "TPostDetectionFreq")
public class PostDetectionFreq {
   ...
   * @return The current PostDetectionFreq object instance
   * @since 3.1.0
   */
  public PostDetectionFreq withCls(String value) {
    setCls(value);
    return this;
  }
   ...
   * @since 3.1.0
   */
  public PostDetectionFreq withMinFreq(BigDecimal value) {
    setMinFreq(value);
    return this;
  }
   ...
   * @since 3.1.0
   */
  public PostDetectionFreq withMaxFreq(BigDecimal value) {
    setMaxFreq(value);
    return this;
  }

  /**
   * Get a string representation of this PostDetectionFreq instance
   * configuration.
   * <p>
   ...
   * <p>
   * {@link PostDetectionFreq} requires {@link null minFreq}.
   * <p>
